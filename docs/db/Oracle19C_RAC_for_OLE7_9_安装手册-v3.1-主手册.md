...
| v3.1 | 2026-07-15 | 项目文档维护人 | 6.5.1.2整节升级v2.5.3→v2.5.10:四种落点/存储方案+落点探测、rsync依赖预检、estimate偏差警示、执行账号统一SYSTEM、空PDB恢复演练标准流程与两轮实测存档;新增6.5.1.2.11现场适配版实例(oracle01/02,v2.5.9_v3全文并入) | 高级DBA复核待定 |
...
#v3.1范围补充:在拆册基线上对6.5.1.2节做内容升级(v2.5.3→v2.5.10,经2026-07-14/07-15两轮现场实测)
#并全文并入现场适配版实例(6.5.1.2.11),属内容变更而非纯搬运,详见修订历史v3.1行。
...
#细化步骤与现场值见6.5.1.2.11(现场适配版实例全文收录)。
...
##### 6.5.1.2.11.现场适配版实例(oracle01/02双节点,v2.5.9_v3全文收录)

#收录说明:本小节为6.5.1.2主节在oracle01/02现场(双节点RAC、三PDB、异地10.4.1.2)的落地实例全文,
#含逐步核查留痕、首跑实录与恢复演练实录;作为主节四方案之外的"参照实施样例",新现场适配时对照裁剪。
#原独立文档《6_5_1_2_v2_5_9_v3_现场适配版_oracle01-02.md》自本手册v3.1起并入本节,不再单独维护。

#基线版本:v2.5.9整合版(本次教训已同步回写6.5.1.2主节,即上文v2.5.10)
...
#过程见附2,标准流程见6.5.1.2.10;下轮从10.4.1.2异地取件以覆盖完整链路);
...
#标准流程与判定口径见6.5.1.2.10,以下仅记录本轮实际操作与结果。
