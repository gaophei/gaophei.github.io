...
public ip            10.0.1.68                           10.0.1.69
private ip           10.0.0.68                            10.0.0.69
vip                  10.0.1.70                           10.0.1.71
scan ip              10.0.1.72
```
#### 1.3.2.网卡配置
...
NAME=eth0
UUID=94a3d5ca-e6f4-4ce8-8a00-7f00b5aae455
DEVICE=eth0
ONBOOT=yes
IPADDR=10.0.1.68
...
[root@stuora2 network-scripts]# cat ifcfg-eth0
TYPE=Ethernet
PROXY_METHOD=none
BROWSER_ONLY=no
BOOTPROTO=static
...
IPV6_ADDR_GEN_MODE=stable-privacy
NAME=eth0
UUID=5bb062c4-d56d-49e0-8b54-e7048251e261
DEVICE=eth0
ONBOOT=yes
IPADDR=10.0.1.69
NETMASK=255.255.255.0
...
eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 10.0.1.68  netmask 255.255.255.0  broadcast 211.70.1.255
...
[root@stuora1 ~]# cd /etc/sysconfig/network-scripts/
[root@stuora1 network-scripts]# ls
ifcfg-eth0     ifdown-sit       ifup-plusb
ifcfg-eth1     ifdown-Team      ifup-post
...
eth0  94a3d5ca-e6f4-4ce8-8a00-7f00b5aae455  ethernet  eth0
eth1  ec6701b2-48ac-4185-bde6-f45bcc1872d8  ethernet  --
[root@stuora1 network-scripts]#

[root@stuora2 network-scripts]# nmcli con show
NAME  UUID                                  TYPE      DEVICE
eth0  5bb062c4-d56d-49e0-8b54-e7048251e261  ethernet  eth0
eth1  4955fbba-b1da-4bce-b700-8506e166af39  ethernet  --


[root@stuora1 network-scripts]# nmcli con add con-name eth1  type ethernet ifname  eth1
Connection 'eth1' (5cbe8fbc-1ec4-4524-ac97-1fd8497fc8b4) successfully added.
[root@stuora1 network-scripts]# ls
...
[root@stuora1 network-scripts]# nmcli conn show
NAME                UUID                                  TYPE      DEVICE
eth1                5cbe8fbc-1ec4-4524-ac97-1fd8497fc8b4  ethernet  eth1
ens18               28273e85-b9c3-4815-b05e-752a69f240f3  ethernet  eth0
...
eth1: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 10.0.0.68  netmask 255.255.255.0  broadcast 10.0.0.6955
...
eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 10.0.1.69  netmask 255.255.255.0  broadcast 211.70.1.255
...
eth1: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 10.0.0.6892  netmask 255.255.255.0  broadcast 10.0.0.6955
...
default via 10.0.0.68 dev eth1 proto static metric 101
3.3.3.0/24 dev eth1 proto kernel scope link src 10.0.0.6891 metric 101
211.70.1.0/24 dev eth0 proto kernel scope link src 10.0.1.68 metric 100
[root@stuora1 network-scripts]# route -n
Kernel IP routing table
Destination     Gateway         Genmask         Flags Metric Ref    Use Iface
0.0.0.0         211.70.1.254    0.0.0.0         UG    100    0        0 eth0
0.0.0.0         10.0.0.68         0.0.0.0         UG    101    0        0 eth1
...
gateway (10.0.0.68) at <incomplete> on eth1
? (10.0.0.6892) at fe:fc:fe:9c:90:bc [ether] on eth1
? (10.0.0.6892) at fe:fc:fe:9c:90:bc [ether] on eth1
[root@stuora1 network-scripts]#

[root@studata2 network-scripts]# arp -a
gateway (211.70.1.254) at 44:82:e5:e0:7d:0c [ether] on eth0
? (10.0.0.6891) at fe:fc:fe:8b:59:ac [ether] on eth1
? (10.0.0.6891) at fe:fc:fe:8b:59:ac [ether] on eth1
...
10.0.1.69 stuora2
#vip
10.0.1.70 stuora1-vip
10.0.1.71 stuora2-vip
#private ip eth1
10.0.0.68 stuora1-prv
10.0.0.69 stuora2-prv
#scan ip
10.0.1.72 rac-scan
...
└─vda2          252:2    0  499G  0 part
  ├─centos-root 253:0    0  467G  0 lvm  /
...
/dev/sda 3600e000000967ad9e787c44b1c5f0c2e
/dev/sdb 3600e000000967ad9e77714ce7fb876b4
/dev/sdc 3600e000000967ad9e72f0fb0721d899c
/dev/sdd 3600e000000967ad9e777680c28efbedb
/dev/sde 3600e000000967ad9e72f50dd4e90ce89
/dev/sdf 3600e000000967ad9e72f6d431a3e678e
/dev/sdg 3600e000000967ad9e777a56a4417a484
[root@stuora1 ~]#
...
KERNEL=="sda", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/$name",RESULT=="3600e000000967ad9e787c44b1c5f0c2e", OWNER="grid",GROUP="asmadmin", MODE="0660"
KERNEL=="sdb", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/$name",RESULT=="3600e000000967ad9e77714ce7fb876b4", OWNER="grid",GROUP="asmadmin", MODE="0660"
KERNEL=="sdc", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/$name",RESULT=="3600e000000967ad9e72f0fb0721d899c", OWNER="grid",GROUP="asmadmin", MODE="0660"
KERNEL=="sdd", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/$name",RESULT=="3600e000000967ad9e777680c28efbedb", OWNER="grid",GROUP="asmadmin", MODE="0660"
KERNEL=="sde", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/$name",RESULT=="3600e000000967ad9e72f50dd4e90ce89", OWNER="grid",GROUP="asmadmin", MODE="0660"
KERNEL=="sdf", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/$name",RESULT=="3600e000000967ad9e72f6d431a3e678e", OWNER="grid",GROUP="asmadmin", MODE="0660"
...
brw-rw----  1 grid asmadmin   8,   0 May 12 10:40 sda
brw-rw----  1 grid asmadmin   8,  16 May 12 10:40 sdb
brw-rw----  1 grid asmadmin   8,  32 May 12 10:40 sdc
brw-rw----  1 grid asmadmin   8,  48 May 12 10:40 sdd
brw-rw----  1 grid asmadmin   8,  64 May 12 10:40 sde
brw-rw----  1 grid asmadmin   8,  80 May 12 10:40 sdf
brw-rw----  1 grid asmadmin   8,  96 May 12 10:40 sdg
[root@stuora1 ~]#

[root@stuora2 ~]# ll /dev|grep asm
brw-rw----  1 grid asmadmin   8,   0 May 12 10:40 sda
brw-rw----  1 grid asmadmin   8,  16 May 12 10:40 sdb
brw-rw----  1 grid asmadmin   8,  32 May 12 10:40 sdc
brw-rw----  1 grid asmadmin   8,  48 May 12 10:40 sdd
...
PING stuora2 (10.0.1.69) 56(84) bytes of data.
64 bytes from stuora2 (10.0.1.69): icmp_seq=1 ttl=64 time=0.128 ms
^C
...
[grid@stuora1 ~]$ ssh stuora2 cat ~/.ssh/id_rsa.pub >>~/.ssh/authorized_keys
The authenticity of host '[stuora2]:23231 ([10.0.1.69]:23231)' can't be established.
...
Warning: Permanently added '[stuora2]:23231,[10.0.1.69]:23231' (ECDSA) to the list of known hosts.
...
stuora2 eth0:10.0.1.69
stuora1 eth0:10.0.1.68

Interfaces found on subnet "3.3.3.0" that are likely candidates for VIP are:
stuora2 eth1:10.0.0.69
stuora1 eth1:10.0.0.68
...
--->eth0:10.0.1.0:Public,eth1:10.0.0.0:Private
--->oracle ASM
DiskGroupName:OCR,normal,AUSize:1M,Candidate Disks:sda/sdb/sdc--->
...
```
 --->create
 --->DATA,normal,sdd/sde/sdf,OK，如果弹框看不到磁盘选择项，可以用鼠标拖动
 --->creat
 --->FRA,external,sdg,OK，如果弹框看不到磁盘选择项，可以用鼠标拖动
 --->exit
```
#验证

```
[grid@stuora1 grid]$ crsctl status resource -t
--------------------------------------------------------------------------------
NAME           TARGET  STATE        SERVER                   STATE_DETAILS
--------------------------------------------------------------------------------
Local Resources
...
ASMCMD> lsdg
State    Type    Rebal  Sector  Block       AU  Total_MB  Free_MB  Req_mir_free_MB  Usable_file_MB  Offline_disks  Voting_files  Name
MOUNTED  NORMAL  N         512   4096  1048576   6291456  6291117          2097152         2096982              0             N  DATA/
MOUNTED  EXTERN  N         512   4096  1048576   1048576  1048472                0         1048472              0             N  FRA/
MOUNTED  NORMAL  N         512   4096  1048576    307200   306274           102400          101937              0             Y  OCR/
ASMCMD> lsdsk
Path
/dev/sda
...
PRVG-1101 : SCAN name "rac-scan" failed to resolve
  ...
  ------------  ------------------------  ------------------------  ----------
  rac-scan      10.0.1.72              failed                    NIS Entry

ERROR:
PRVF-4657 : Name resolution setup check for "rac-scan" (IP address: 10.0.1.72) failed
...
#比如
sqlplus test/test@10.0.1.72:1521/xydb
```
#日志
```
[root@stuora1 ~]# su - grid
...
Listening Endpoints Summary...
  ...
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=10.0.1.68)(PORT=1521)))
  (DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=10.0.1.70)(PORT=1521)))
Services Summary...
...
expdp system/Ora543Cle directory=expdir dumpfile=$dmpfilename logfile=$logfilename full=y  parallel=4 cluster=N
